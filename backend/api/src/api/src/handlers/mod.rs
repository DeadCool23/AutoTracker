...
pub use dependencies_container::error::ServiceError;
pub use dependencies_container::{BLServices, BUSINESS_PROCCESS};
...
use search_services::{
    ...
    car_search_services::{
        CarSearcherResponse,
        __path_handle_search_car_by_fio,
        __path_handle_search_car_by_passport,
        __path_handle_search_car_by_gos_num_mask
    },
    track_info_search_services::{
        TrackInfoSearcherResponse, 
        __path_handle_search_track_info_by_fio,
        __path_handle_search_track_info_by_date,
        __path_handle_search_track_info_by_passport,
        __path_handle_search_track_info_by_gos_num_mask
    }
};
...
#[openapi(
    paths(
        handle_route, 
        handle_auth, handle_reg, handle_passport_conf, 
        handle_snap_send,
        handle_search_car_by_fio, handle_search_track_info_by_fio,
        handle_search_car_by_passport, handle_search_track_info_by_passport,
        handle_search_car_by_gos_num_mask, handle_search_track_info_by_gos_num_mask,
        handle_search_track_info_by_date
    ),
    components(schemas(
        RouteRequest, RouteResponse, AuthRequest, AuthResponse, 
        ...
        SearchByDateRequest, SearchByGosNumRequest, SearchByPassportRequest
    )),
    tags(
