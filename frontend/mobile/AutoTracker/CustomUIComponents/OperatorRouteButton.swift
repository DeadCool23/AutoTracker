...
class OperatorRouteButton : UIControl {
    let car: Car
    ...
    private func setupView() {
        ...
        let fioLabel = configureLabel(
            text: "\(car.owner_fio.surname.capitalized) \(car.owner_fio.name.capitalized)",
        ...
        let gosNumLabel = configureGosNum(gosNum: car.gos_num)
        ...
        NSLayoutConstraint.activate([
            gosNumLabel.topAnchor.constraint(equalTo: topAnchor, constant: inMiddleFrameAligment),
